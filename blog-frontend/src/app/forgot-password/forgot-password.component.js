...
var inser_code_component_1 = require("./inser-code/inser-code.component");
var ForgotPasswordComponent = function () {
    var _classDecorators = [(0, core_1.Component)({
            selector: 'app-forgot-password',
            imports: [
                inser_code_component_1.InserCodeComponent
            ],
    ...
    var ForgotPasswordComponent = _classThis = /** @class */ (function () {
        function ForgotPasswordComponent_1() {
            this.codeCorrect = false;
        }
        ForgotPasswordComponent_1.prototype.goToPasswordSetting = function (e) {
            this.codeCorrect = e;
        };
