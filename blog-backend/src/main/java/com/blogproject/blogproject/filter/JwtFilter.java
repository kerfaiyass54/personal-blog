...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return path.startsWith("/user/") || path.startsWith("/api/favorites/") || path.startsWith("/api/skill-keywords/")  || path.startsWith("/api/keywords/")                || path.startsWith("/reset") || path.startsWith("/profiles") || path.startsWith("/api/skills") || path.startsWith("/api/skills-recommendations")
