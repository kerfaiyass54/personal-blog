...
@Configuration
public class KafkaProducerConfigRecommandation {

    @Bean
    public ProducerFactory<String, RecommendationRequestDTO>
    ...
    @Bean
    public KafkaTemplate<String, RecommendationRequestDTO>
